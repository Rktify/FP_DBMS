<<<<<<< HEAD:build/gui/Manage/Participants/main.py
from pathlib import Path
from tkinter import Tk, Canvas, Entry, Text, Button, PhotoImage, Toplevel
from ..Tickets.main import ticketsWindow
...
class Participants(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Evenementiel Adding Participants")
...
class Participants(Toplevel):
    ...
    def handle_button_press(self):
        ...
        ticketsWindow()
        return
>>>>>>> d865fa75a5773912dde1b399f70a39f3e6cecd52:build/gui/Create/Participants/main.py
